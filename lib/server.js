...
function IMAPServer(options) {
    ...
    const client = this.createClient.bind(this);
...
IMAPConnection.prototype.send = function(response, description, parsed) {
    return new Promise( async (resolve, reject) => {
        ...
        if (this.server.notifiable && !response.notification && response.tag !== "*") {
        ...
        let compiled = imapHandler.compiler(response) || '';
